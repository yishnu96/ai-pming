...
description: "Learn to request JSON, XML, and markdown output formats from AI, and understand when each format works best."
slug: /output-formats-json-xml-markdown
tags: [prompting, JSON, XML, markdown, output formats]
keywords: [AI output formats, JSON prompting, XML tags for prompts, markdown tables, structured AI output]
sidebar_position: 3
...
<Star1 color="#118AB2" stroke="black" strokeWidth={2} size={32} style={{position: 'absolute', top: '-10px', right: '20px'}} />
...
:::tip Use JSON
You plan to move the output into a spreadsheet, database, or another tool.
:::
