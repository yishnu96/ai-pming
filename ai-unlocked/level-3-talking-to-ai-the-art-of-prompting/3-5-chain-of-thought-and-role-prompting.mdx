---
title: "Chain-of-Thought and Role Prompting"
description: "Make AI reason step by step with chain-of-thought prompting and respond with expert depth using role prompting."
slug: /chain-of-thought-and-role-prompting
tags: [prompting, chain-of-thought, role prompting, AI quality]
keywords: [chain of thought prompting, role prompting, CoT prompting, expert AI, step by step reasoning]
...
<div style={{position: 'relative'}}>
<Star9 color="#A06CD5" stroke="black" strokeWidth={2} size={28} style={{position: 'absolute', top: '-8px', left: '-10px'}} />
